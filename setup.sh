...
function setup_git_convenience {
	...
	git_load_helper https://raw.github.com/benseven/git-convenience-no-rebase/master/terminal-prefs.sh "$HOME/.terminal-prefs.sh" "$bash_startup_file" "$1"
	git_load_helper https://raw.github.com/benseven/git-convenience-no-rebase/master/git-shortcuts.sh "$HOME/.git-shortcuts.sh" "$bash_startup_file" "$1"
